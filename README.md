...
|---|---|---|
| `dnd-app/` | D&D campaign app — Convex backend + Next.js player web app (live map, combat tracker) | Backend + player app built; DM desktop app (Tauri) is next |
...
- **Frontends** on Vercel Hobby (Next.js); DM desktop client later via Tauri
...
a live view of whatever the DM puts on the table: active map with optional
